...
//{
//  setupUi(ifcname, parentWidget);
//}

TNetworkStateLabel::TNetworkStateLabel(const QNetworkInterface& ifc, QWidget* parentWidget):
  _ifc(ifc)
{
  setupUi(_ifc.humanReadableName(), parentWidget);
}

void TNetworkStateLabel::setupUi(const QString& ifcname, QWidget* parentWidget)
{
  ...
  lblIp->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Preferred); // sizePolicy);
